...
func StartProcessor(m messenger.Messenger, done chan bool, appWg *sync.WaitGroup, inputsCh chan io.Inputs, procFun func(ProcCtx) error) (outputsCh chan io.Outputs, err error) {
...
func Processor(procFun func(ProcCtx) error, done chan bool, appWg *sync.WaitGroup, inputsCh chan io.Inputs, outputsCh chan io.Outputs) {
	defer appWg.Done()
	for {
		select {
...
func processInputs(inputs io.Inputs, procFun func(ProcCtx) error, outputsCh chan io.Outputs) {
	// TODO: Build ProcCtx
