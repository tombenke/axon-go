...
type Config struct {
	...
	// The name of the JavaScript file that holds the implementation of the processor function
...
func GetAppFlagSet(appName string, cfg *Config) *flag.FlagSet {
	...
	fs.StringVar(&cfg.ScriptFile, "scriptfile", "function.js", "The name of the JavaScript file that holds the function implementation.")
...
func mergeConfigs(builtInConfigContent Config, cliConfigContent Config) Config {
	...
	resultingConfig.ScriptFile = cliConfigContent.ScriptFile
